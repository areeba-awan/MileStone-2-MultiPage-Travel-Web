    ...
    <div className="flex justify-center items-center min-h-screen bg-slate-200 px-4">
      <div className="text-center shadow-2xl w-full h-auto sm:w-[80%] md:w-[60%] lg:w-[40%] px-4 sm:px-8 md:px-12 py-10 rounded-lg bg-white">
        ...
        <div className="space-y-5 mt-8">
          ...
          <button className="bg-cyan-600 hover:bg-blue-700 text-white py-2 px-4 w-full rounded-md transition duration-300 ease-in-out">
            Send Message
          </button>
        </div>
        ...
        <div className="mt-5">
          <Link href={"/Contact/Login"}>
            <p className="text-gray-600">
              Already have an account?{" "}
              <span className="underline cursor-pointer text-green-700 font-bold">
                Login
              </span>
            </p>
          </Link>
