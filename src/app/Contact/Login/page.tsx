...
const page = () => {
  return (
    <div className="flex justify-center items-center min-h-screen bg-purple-300 px-4">
      <div className="text-center shadow-2xl bg-white w-full h-auto sm:w-[80%] md:w-[60%] lg:w-[40%] px-6 sm:px-10 py-10 rounded-lg">
        ...
        <div className="space-y-6 mt-8">
          ...
          <button className="bg-indigo-700 hover:bg-blue-500 text-white py-3 px-4 w-full rounded-md transition duration-300">
            Log In
          </button>
        </div>
      </div>
