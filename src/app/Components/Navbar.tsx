...
const Navbar = () => {
  ...
  return (
    <div>
      <div className="bg-blue-900 w-full h-[60px] flex justify-between items-center px-10 text-white">
        <div className="font-bold text-[20px] sm:text-[25px] w-full flex justify-between ">
        {/* Logo
        <div className="w-10 h-10 bg-rose-500 rounded-full flex items-center justify-center flex-col">
        <TbAirBalloon className="w-6 h-6 text-white"/>
        </div> */}
        <Link href={"/"} className="text-3xl text:md-2xl text-white uppercase  font-bold ">Tripiii.</Link>
        ...
        <div
          ...
          absolute top-20 bg-blue-900 w-full left-0 flex justify-center md:relative md:top-0 md:flex md:w-auto md:items-center z-10 pb-2 sm:pb-0`}
        >
          <div className="flex flex-col sm:flex-row h-auto items-center gap-3 sm:gap-9 font-bold ">
            ...
            absolute top-[50px] right-0 bg-emerald-200 shadow-lg rounded-xl w-[280px] h-[250px] sm:w-[320px] py-4 px-6 z-50 `}
            >
